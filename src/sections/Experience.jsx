...
const experiences = [
  ...
  },
  {
    ...
    company: "Shwe 13 Solution",
    duration: "2026",
    description: "Built local brand",
  },
  {
    role: "Product Builder",
    company: "Unique Solution Tech",
    duration: "2026",
...
function ExperienceItem({ exp, idx, start, end, scrollYProgress, layout, language }) {
  ...
  if (layout === "desktop") {
    return (
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        <motion.div
          className="z-10 w-7 h-7 rounded-full bg-gradient-to-r from-orange-400 to-orange-500 shadow-[0_0_0_8px_rgba(249,115,22,0.15)]"
          style={{ scale, opacity }}
        />
        <motion.div
          className={`absolute ${idx % 2 === 0 ? "-top-8" : "-bottom-8"} w-[3px] bg-gradient-to-b from-orange-300 to-orange-500/40`}
          style={{ height: 40, opacity }}
        />
        <motion.article
          className={`absolute ${idx % 2 === 0 ? "bottom-12" : "top-12"} bg-white border border-orange-200 rounded-xl p-7 w-[320px] shadow-lg hover:shadow-orange-200/30 transition-shadow duration-300`}
          style={{ opacity, y, maxWidth: "90vw" }}
          transition={{ duration: 0.4, delay: idx * 0.10 }}
          whileHover={{ scale: 1.02, borderColor: "#f97316" }}
        >
          <h3 className='text-xl font-semibold text-gray-800'>{exp.role}</h3>
          <p className='text-md text-orange-500 mb-3 font-medium'>
            {exp.company} | {exp.duration}
          </p>
          <p className="text-md text-gray-600 break-words">{exp.description}</p>
        </motion.article>
      </div>
    );
  }
  ...
  return (
    <div className="relative flex items-start">
      <motion.div
        className='absolute -left-[14px] top-3 z-10 w-7 h-7 rounded-full bg-gradient-to-r from-orange-400 to-orange-500 shadow-[0_0_0_8px_rgba(249,115,22,0.15)]'
        style={{ scale, opacity }}
      />
      <motion.article
        className='bg-white border border-orange-200 rounded-xl p-5 w-[90vw] max-w-sm ml-6 shadow-lg hover:shadow-orange-200/30 transition-shadow duration-300'
        style={{ opacity, x }}
        transition={{ duration: 0.4, delay: idx * 0.10 }}
        whileHover={{ scale: 1.02, borderColor: "#f97316" }}
      >
        <h3 className="text-lg font-semibold text-gray-800 break-words">{exp.role}</h3>
        <p className="text-sm text-orange-500 font-medium mb-2 break-words">
          {exp.company} | {exp.duration}
        </p>
...
const Experience = () => {
  ...
  return (
    <>
      ...
      <section className="bg-white text-gray-800 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        {/* Soft Orange Background Glows */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 right-10 w-80 h-80 rounded-full bg-orange-100/30 blur-3xl animate-pulse" />
          <div className="absolute bottom-20 left-10 w-96 h-96 rounded-full bg-orange-50/40 blur-3xl animate-pulse delay-700" />
        </div>

        <div className="relative max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <h1 className="text-4xl sm:text-5xl font-bold text-center bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
              {t.bio.title}
            </h1>
            
            {/* Language toggle buttons */}
            <div className="flex gap-2 bg-white border border-orange-200 rounded-lg p-1 shadow-sm">
              {[
                { code: 'en', label: 'ENG' },
                { code: 'ko', label: 'KOREA' },
                ...
                <motion.button
                  ...
                  className={`px-3 py-1 rounded-md text-sm font-medium transition-all ${
                    language === lang.code 
                      ...
                      : 'text-gray-600 hover:text-yellow-500 hover:bg-yellow-100'
                  }`}
                >
                  {lang.label}
                </motion.button>
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed">
            ...
            <motion.div 
              ...
              className="border-l-4 border-yellow-400 pl-6 hover:border-yellow-500 transition-colors"
            >
              <h2 className="text-xl font-semibold text-yellow-500 mb-2">Unique Solution Tech</h2>
              <p>{t.bio.uniqueSol}</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="border-l-4 border-yellow-400 pl-6 hover:border-yellow-500 transition-colors"
            >
              <h2 className="text-xl font-semibold text-yellow-500 mb-2">Shwe 13 Solution</h2>
              <p>{t.bio.shwe13}</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="border-l-4 border-yellow-400 pl-6 hover:border-yellow-500 transition-colors"
            >
              <h2 className="text-xl font-semibold text-yellow-500 mb-2">FEARLESS & T14K</h2>
              <p>{t.bio.fearless}</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="border-l-4 border-yellow-400 pl-6 hover:border-yellow-500 transition-colors"
            >
              <h2 className="text-xl font-semibold text-yellow-500 mb-2">T15H Community Support Group</h2>
              <p>{t.bio.t15h}</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="border-l-4 border-yellow-400 pl-6 hover:border-yellow-500 transition-colors"
            >
              <h2 className="text-xl font-semibold text-yellow-500 mb-2">{language === 'en' ? 'Education & Mentorship' : language === 'ko' ? '교육 및 멘토링' : 'ပညာရေးနှင့် လမ်းညွှန်မှု'}</h2>
              <p>{t.bio.education}</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="mt-8 p-6 bg-gradient-to-r from-yellow-50 to-yellow-100/50 rounded-xl border border-yellow-200"
            >
              <p className="text-lg text-yellow-700 italic">{t.bio.mission}</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      {/* Experience Section */}  
      <div id='experience' className="relative bg-yellow-100">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-0 w-64 h-64 rounded-full bg-yellow-100/20 blur-3xl" />
        </div>
        ...
        <motion.div ref={sceneRef} className="relative" style={{ height: `${SCENE_HEIGHT_VH}vh`, minHeight: "140vh" }}>
          <div className="sticky top-5 h-screen flex flex-col">
            <motion.h2 
              className='text-4xl sm:text-5xl font-bold mt-5 text-center bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent'
            ...
            >
              {t.experience}
              <motion.span 
                className="block w-20 h-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full mx-auto mt-2"
                initial={{ width: 0 }}
                animate={{ width: 80 }}
            ...
            <div className="flex flex-1 items-center justify-center px-6 pb-10">
              {!isMobile && (
                <div className="relative w-full max-w-5xl">
                  <div className="relative h-[6px] bg-orange-100 rounded">
                    <motion.div
                      className='absolute left-0 top-0 h-[6px] bg-gradient-to-r from-orange-400 to-orange-500 rounded origin-left'
              ...
              {isMobile && (
                <div className="relative w-full max-w-md">
                  <div className="absolute left-0 top-0 bottom-0 w-[6px] bg-orange-100 rounded">
                    <motion.div
                      className="absolute top-0 left-0 w-[6px] bg-gradient-to-b from-orange-400 to-orange-500 rounded origin-top"
