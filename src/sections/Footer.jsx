...
const Footer = () => {
  ...
  return (
    <div className='relative overflow-hidden bg-black'>
      ...
      >
        <h1 className="font-semibold leading-none text-red-400 text-center select-none"
        ...
        <div className='h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from-[#0d58cc] via-red-500 to-red
        -400' />
        <div className='flex gap-5 text-2xl md:text-3xl'>
          {socials.map(({ Icon, label, href }) => (
            <motion.a href={href}
              ...
              whileHover="hover"
              whileTap="tap"
              className='text-red-900 transition-colors duration-200 inline-flex items-center justify-center'
            >
              <Icon />
            </motion.a>
        ...
        <p className='text-blue-300 italic max-w-xl'>
          "Success is when preparation meets opportunity"

        </p>
        <p className="text-xs text-blue-400">
          &copy;{new Date().getFullYear() } Thitsar Aung . All rights reserved.
        </p>
