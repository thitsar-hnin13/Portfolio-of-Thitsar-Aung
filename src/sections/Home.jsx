...
const translations = {
  en: {
    ...
    hello: "Hello I'm",
    name: "Thitsar Aung",
    description: "I am a passionate Web Developer focused on building modern and responsive websites. I specialize in React, Tailwind CSS, and creating clean, intuitive UI/UX designs to deliver smooth and engaging user experiences.",
  ...
  ko: {
    ...
    hello: "안녕하세요, 저는",
    name: "띳싸아웅",
    description: "저는 현대적이고 반응형 웹사이트를 구축하는 데 열정을 가진 웹 개발자입니다. React, Tailwind CSS를 전문으로 하며 깔끔하고 직관적인 UI/UX 디자인을 만들어 부드럽고 매력적인 사용자 경험을 제공합니다.",
    viewWork: "내 작업 보기",
    resume: "이력서",
    phoneNumber: "전화번호",
    copy: "복사",
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative ">
          <div className="w-full lg:pr-24 lg:p-20 mx-auto max-w-[40rem]">
            ...
            <div className="mt-8 flex flex-wrap gap-5 text-2xl md:text-3xl justify-center lg:justify-start">
              {firstRowSocials.map(({ Icon, labelKey, href, isPhone, phoneNumber, color, hoverColor }) => (
                <motion.a
                  key={labelKey}
                  href={isPhone ? "#" : href}
